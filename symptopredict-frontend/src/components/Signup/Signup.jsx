...
const Signup = () => {
  ...
  return (
    <div className='relative h-screen w-screen overflow-hidden flex items-center justify-center'>
      ...
      />
      <div className='relative z-10 flex flex-col gap-7 mx-auto w-10/12 sm:w-2/3 md:w-1/2 lg:w-1/3 px-[7%] py-[6%] sm:py-[4%] md:py-[3%] lg:py-[2%] lg:px-[5%] xl:px-[7%] bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-3xl border-2 border-[#e9e9e93d] heroSectionFont shadow-2xl'>
